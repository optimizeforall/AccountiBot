...
@tree.command(name="name", description="description", guild=discord.Object(id=1014983443756613672))
async def slashing_commanding(int: discord.Interaction):    
    await int.response.send_message("command")

@tree.command(name="ping", description="description", guild=discord.Object(id=1014983443756613672))
async def slashing_commanding(int: discord.Interaction, arg: str):    
    await int.response.send_message("pong to " + arg)
